...
def main(argv):
    ...
    agg=argv[2]
    name=sel+'_'+cls
    rdir='/nfs/rnas/clolivia/_Experiments/immuno_paper/codis_laia/'+agg+'.csv'
    cdir='/nfs/rnas/clolivia/_Experiments/immuno_paper/codis_laia/clinical_biological_db_20230905.csv'
    odir='/nfs/rnas/clolivia/_Experiments/immuno_paper/codis_laia/results/'+agg
...
#per runnejar el codi utilitzem la següent línia
